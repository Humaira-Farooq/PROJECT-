                ...
                <tbody class="align-middle">
                    ...
                    ?>
                            <tr>
                                ...
                                <td class="align-middle"><?php echo $fetch_products['pro_price']; ?></td>
                                <td class="align-middle">
                                    <div class="input-group quantity mx-auto" style="width: 100px;">
                                        ...
                                        <input type="text" class="form-control form-control-sm bg-secondary text-center"value="1" name="quantity">
                                        <div class="input-group-btn">
